...
class _RecommdatorState extends State<Recommdator> {
  ...
  Widget build(BuildContext context) {
    ...
    final TextEditingController irrigationTypeTypeController = TextEditingController();
    return Column(
      children: [
        Expanded(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  customTextField(kcontroller: soilTypeController,hintText: "Soil Type"),
                  customTextField(kcontroller: saplingTypeController,hintText: "Type of Sapling"),
                  customTextField(kcontroller: irrigationTypeTypeController,hintText: "Type of fertilizer"),
                  ...
                  Text("1.Ammonium Sulphate\n2.Single Super Phospate\n3. Urea", style: smallbody(),),
                  SizedBox(
                    height: screenHeight * 0.01,
                  ),
                ],
