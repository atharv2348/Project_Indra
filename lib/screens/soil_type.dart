...
class _SoilTypeState extends State<SoilType> {
  ...
  Widget build(BuildContext context) {
    ...
    final TextEditingController fertilizerTypeController = TextEditingController();
    return Column(
      children: [
        Expanded(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  customTextField(kcontroller: fertilizerTypeController,hintText: "Type of fertilizer"),
